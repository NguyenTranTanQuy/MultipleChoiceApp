...
public class LevelQuestion extends AppCompatActivity {
    ...
    private void setEvent() {
        ...
        btnExamLevel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check){
                    ...
                    Toast.makeText(LevelQuestion.this, "Không có bài thi thuộc level: "+level, Toast.LENGTH_SHORT).show();
                }
        ...
        btnHomeLevelExam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(LevelQuestion.this, Home.class);
        ...
        snLevel.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) { // Ensure not to toast when "List Question" is selected
                    level = position +1;
