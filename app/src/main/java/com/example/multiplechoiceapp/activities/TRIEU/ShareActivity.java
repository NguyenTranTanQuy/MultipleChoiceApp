                ...
                userAdapter = new UserAdapter(new ClickListener() {
                    ...
                    public void onPositionClicked(int position, int status) {
                        if(status == 0){
                            ...
                            usernameList.remove(new Username(userList.get(position).getUsername()));
                        }
            ...
            builder1.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Log.d("dataUser",new UsernameList(usernameList).toString());
                            ApiUtils.apiTopicInterface().shareTopicSetToUsers(topicID, topicSetCode, new UsernameList(usernameList))
